...
UPDATE = ("обнови", "обновить", "сколько", "натикало", "узнать")
...
BUTTONS = \
    {
        ...
        "update": {"title": "Узнать время", "hide": True},
        "stop": {
            "title": "Завершить",
            "hide": True
        },
        ...
        "create_thing":
            {
                ...
                "0": {
                    ...
                    "errors": {
                        "serv": [['Название не должно содержать служебные слова, такие как: "дела","засечь" и т.д.',
                ...
                "3": {"start": [[
                    ...
                    "help": [[
                        ...
                        ' Скажите "Список", чтобы услышать список.']],
                    "else": [
                        ['Такого дела не нашла. Попытайтесь снова. Также вам доступны команды "Отмена" и "Список".',
        ...
        "time_flow":
            {
                "start":
                    {"new_session": [['Текущее задание: "{}"\nВремени прошло: {}:{}:{}',
                     ...
                     "start_words": [['Отсчёт пошёл!', 'Отсчёт пошёл!'], ['Поехали!', 'Поехали!'],
                                     ['Начинаем!', 'Начинаем!']],
                     "start_actions": [['Чтобы посмотреть сколько прошло времени, скажите "Узнать время".'
                                        ' Когда завершите своё дело, произнесите "Завершить".',
                                        'Чтобы посмотреть сколько прошло времени, скажите "Узнать время".'
                                        ' Когда завершите своё дело, произнесите "Завершить"'],
                                       ['', 'Узнать время. sil <[300]> Завершить.']]
                     },
                ...
                "help": [[
                    'Скажите "Узнать время", чтобы посмотреть сколько времени прошло. Когда завершите своё дело, произнесите'
